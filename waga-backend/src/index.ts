...
import forumPostsRoutes from './routes/forumPosts'; // Import forumPosts routes
import forumTopicsRoutes from './routes/forumTopics'; // Import forumTopics routes
import coursesRoutes from './routes/courses'; // Import courses routes
import eventsRoutes from './routes/events'; // Import events routes
...
// Mount the forum posts routes
app.use('/api/forum/posts', forumPostsRoutes);

// Mount the forum topics routes
app.use('/api/forum/topics', forumTopicsRoutes);
