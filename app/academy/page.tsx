...
export default function AcademyPage() {
  return (
    <div className="flex flex-col gap-16 py-8">
      {/* Hero Section */}
      <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-muted/30 relative">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] rounded-xl overflow-hidden web3-card-featured">
              ...
              />
              {/* Strategic coffee bean in the hero section */}
              <StrategicCoffeeBeans position="bottom-right" size={35} zIndex={10} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="relative h-[300px] sm:h-[400px] rounded-xl overflow-hidden">
              ...
              />
              {/* Strategic coffee bean in the vision section */}
              <StrategicCoffeeBeans position="top-left" size={28} opacity={0.7} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="w-full max-w-4xl pt-8 relative">
              {/* Strategic coffee bean near the value chain section */}
