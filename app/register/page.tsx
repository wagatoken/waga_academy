  ...
  async function onSubmit(values: z.infer<typeof registerFormSchema>) {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to the WAGA Early Access Community. Please check your email to confirm your account.",
      })
      router.push("/login")
    } catch (error) {
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input placeholder="John" className="pl-10 web3-input" {...field} />
                          </div>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            <User className="absolute left-3 top-3 h-4 w-4 text-purple-400" />
                            <Input placeholder="Doe" className="pl-10 web3-input" {...field} />
                          </div>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
