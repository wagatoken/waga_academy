      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-6 animate-fade-in relative">
            ...
            <StrategicCoffeeBeans position="top-right" size={28} zIndex={5} />
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 w-full pt-8 relative">
            ...
            {valueChainStages.map((stage, index) => {
              ...
              // Add coffee bean to the first card (cultivation)
              const showCoffeeBean = index === 0

              return (
                <Card
                  key={index}
                  className={`${cardClass} flex flex-col h-full transition-all duration-300 animate-fade-in animate-float ${animationDelay} hover:scale-105 hover:shadow-lg relative`}
                >
                  {showCoffeeBean && (
