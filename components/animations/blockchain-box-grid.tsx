  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      boxesRef.current.forEach((box, index) => {
        ...
        // Use alternating emerald-purple colors with varying opacity
        ...
        if ((row + col) % 2 === 0) {
          ...
          box.style.backgroundColor = `rgba(147, 51, 234, ${opacity * 0.8})`
          box.style.borderColor = `rgba(147, 51, 234, ${opacity * 0.8 + 0.3})`
        }
      })
