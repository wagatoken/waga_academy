  ...
  return (
    <footer className="border-t border-opacity-20 backdrop-blur relative overflow-hidden">
      ...
      <div className="absolute top-10 right-10 z-10">
        <StrategicCoffeeBeans position="top-right" size={25} opacity={0.6} />
      </div>
      <div className="absolute bottom-20 left-10 z-10">
        <StrategicCoffeeBeans position="bottom-left" size={20} opacity={0.5} quantity={2} />
      </div>
      ...
      <div className="container py-8 md:py-12 relative z-10">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="space-y-3">
            <h3 className="text-lg font-medium web3-dual-gradient-text-glow">Legal</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/terms"
